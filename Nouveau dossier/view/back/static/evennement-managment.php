...
{
    if(!empty($_POST['nomevent']) && !empty($_POST['prix']) && !empty($_POST['dateheure']) && !empty($_POST['localisation']))
    {
		...
		$event = new Event(NULL, $nomevent, $prix , $dateheure, $localisation);
					 ...
					 <div id="popup-container-Admin" class="popup-container-Admin" style="width: 28%;">
						...
						<div id="popup-content-Admin" class="">
							...
							<form action="" method="post" style="height: 400px;">
                                ...
                                <input type="datetime-local" name="dateheure" id="dateheure" required>
                                <br>
								...
								<table class="table table-hover my-0">
									...
									<?php foreach ($events as $event): ?>
                                    	<tr>
											...
											<td   >
                                    			<span><?php echo $event["nomevent"]; ?></span>
                                    		</td>
											<td   >
                                    		...
                                    		<td class=""name="product-name"><?php echo $event["localisation"]; ?></td>
                                    		<td>
