        ...
        <div class="row g-5 mt-5 pt-5">
            <div class="col-lg-6 wow fadeInUp " data-wow-delay="0.1s">
                <div class="section-title position-relative mb-4 pb-2 ">
                    ...
                    <h2 class="mt-2" data-aos="fade-right" data-aos-delay="400">The best SEO solution with 10 years of experience</h2>
                </div>
                <p class="mb-4" data-aos="fade-right" data-aos-delay="400">Tempor erat elitr rebum at clita. Diam dolor diam ipsum et tempor sit. Aliqu diam amet diam et eos labore. Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus clita duo justo et tempor eirmod magna dolore erat amet</p>
            ...
            <div class="col-lg-4 wow fadeInUp"  data-wow-delay="0.1s"data-aos="fade-up" data-aos-delay="600">
                <div class="team-item" >
                    <div class="d-flex">
                        ...
                        <img class="img-fluid rounded w-100" src="assets/images/team-1.jpg" alt="">
                    </div>
                    <div class="px-4 py-3">
            ...
            <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.3s"data-aos="fade-up" data-aos-delay="600">
                <div class="team-item">
                    <div class="d-flex">
                        ...
                        <img class="img-fluid rounded w-100" src="assets/images/team-2.jpg" alt="">
                    </div>
                    <div class="px-4 py-3">
            ...
            <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.6s"data-aos="fade-up" data-aos-delay="600">
                <div class="team-item">
                    <div class="d-flex">
                        ...
                        <img class="img-fluid rounded w-100" src="assets/images/team-3.jpg" alt="">
                    </div>
                    <div class="px-4 py-3">
