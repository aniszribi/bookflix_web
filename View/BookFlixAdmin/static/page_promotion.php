...
$listePromo=$promoP->afficherpromotion();
...
<head>
    ...
    <script src="../../../Core/promotion.js"></script>
</head>
            ...
            <main class="content ">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <div id="popup-container-Admin" class="popup-container-Admin" style="width: 28%;">
                        <a href="page_promotion.php" id="close-popup-Admin"><i class="fas fa-times"></i></a>
                        <div id="popup-content-Admin" class="">

                            <h4 class="model-titel">ajouter un nouveau Promotion </h4>
                            <form action="ajouter-promotion.php" method="post">
                                <!--product name-->
                                <label for="produit">produit:</label>

                                <select name="produit" id="produit" class="form-select mb-3" onchange="showFields2()">
                                    <?php foreach ($products as $product){ ?>
                                    <option value=<?php echo $product->getName(); ?>><?php echo $product->getName(); ?>
                                    </option>
                                    <?php
                                    }
                                    ?>
                                ...
                                <!--refernce name-->
                                <label for="date_d">date_debut:</label>
                                <input type="date" placeholder="" id="date_d" name="date_d">
                                <!--product quantity-->
                                <label for="date_f">date_fin:</label>
                                <input type="date" placeholder="" id="date_f" name="date_f">

                                <label for="prix_old">ancien prix:</label>
                                <input onchange="Equation()" type="double" step="any" name="prix_old" id="prix_old">
                              
                                <label for="pourcentage">pourcentage:</label>
                                <input onchange="Equation()" type="double" step="any" name="pourcentage" id="pourcentage">
                                       
                                <!--product price-->
                                <label for="prix_new">nouveau prix:</label>
                                <input type="double" step="any" value="0.000" id="prix_new" name="prix_new" readonly>
                                
                                <!--Number Of Photos-->

                                <div class="d-flex align-items-center justify-content-between mb-3  ">
                                    <a href="page_promotion.php" class="btn btn-secondary btn-block mt-3"
                                ...
                                <table class="table table-hover my-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>date_debut</th>
                                            <th class="d-none d-xl-table-cell">date_fin</th>
                                            <th>ancien_prix</th>
                                            <th class="d-none d-md-table-cell">pourcentage</th>
                                            <th>nouveau_prix</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($listePromo as $promotion): ?>
                                        <tr>
                                            <td>
                                                <?PHP echo $promotion['nom_produit']; ?>
                                            </td>
                                            <td>
                                                <?PHP echo $promotion['date_d']; ?>
                                            </td>
                                            <td>
                                                <?PHP echo $promotion['date_f']; ?>
                                            </td>
                                            <td>
                                                <?PHP echo $promotion['prix_old']; ?>
                                            </td>
                                            <td>
                                                <?PHP echo $promotion['pourcentage']; ?>
                                            </td>
                                            <td>
                                                <?PHP echo $promotion['prix_new']; ?>
                                            </td>
                                            <td style="width=" 70%>
                                                <form method="POST" action="supprimer-promotion.php">
                                                    <input type="submit" name="delete" value="Delete"
                                                        class="btn btn-danger btn-block">
                                                    <input type="hidden" value="<?php echo $promotion['id']; ?>"
                                                        name="id">
                                                </form>
                                            </td>
                                            <td style="width=" 70%>
                                            <td><a class="btn btn-success btn-block"
                                                    href="modifier-promotion.php?id=<?PHP echo $promotion['id']; ?>">
                                                    Modifier</a></td>
                                            </td>
