  ...
  if( $category=="Books")
   {
	 if(!empty($_POST['author']) && !empty($_POST['publisher']))
	 {
		 ...
		 if(!empty($_POST['updating']))
		 {
			...
			$description = "You have Updated a VoiceOver that containe The id is:".$id." named :".$name."<br> price : ".$price."<br> the author: ".$author;
			...
			$currentDateTime = date('Y-m-d H:i:s');
			$description = "You have Added a Book  named :".$name."<br> price : ".$price."<br> the author: ".$author;
			$newActivitie = new Activities('', $_SESSION['idAdmin'], $description, $currentDateTime, '');
			CrudActivities::insert($newActivitie);
		 }
	 }
   ...
   if( $category=="Voice Over")
   {
	 if(!empty($_POST['format']) && !empty($_POST['duration']))
	 {
		 ...
		 if(!empty($_POST['updating']))
		 {
			...
			$currentDateTime = date('Y-m-d H:i:s');
			$description = "You have Updated a VoiceOver that containe The id is:".$id." named :".$name."<br> price : ".$price."<br> the referance: ".$referance;
			$newActivitie = new Activities('', $_SESSION['idAdmin'], $description, $currentDateTime, '');
			CrudActivities::insert($newActivitie);	 	 
		}
		 else{
			...
			$currentDateTime = date('Y-m-d H:i:s');
			$description = "You have Added a VoiceOver  named :".$name."<br> price : ".$price."<br> the referance: ".$reference;
			$newActivitie = new Activities('', $_SESSION['idAdmin'], $description, $currentDateTime, '');
			CrudActivities::insert($newActivitie);
		}
	 }
   ...
   if( $category=="Movies")
   {
	 if(!empty($_POST['director']) && !empty($_POST['publisher2']))
	 {
		 ...
		 if(!empty($_POST['updating']))
		 {
			...
			$currentDateTime = date('Y-m-d H:i:s');
			$description = "You have Updated a Movie that containe The id is:".$id." named :".$name."<br> Color : ".$color."<br> the Categorie: ".$categories;
			$newActivitie = new Activities('', $_SESSION['idAdmin'], $description, $currentDateTime, '');
			CrudActivities::insert($newActivitie);	 	 
		}
		 else{
			...
			$currentDateTime = date('Y-m-d H:i:s');
			$description = "You have add a new Movie named :".$name."<br> Publisher : ".$publisher2."<br> the Categorie: ".$categories;
			$newActivitie = new Activities('', $_SESSION['idAdmin'], $description, $currentDateTime, '');
			CrudActivities::insert($newActivitie);	      
		}
	 }
	 ...
	 if(!empty($_POST['size']) && !empty($_POST['color']))
 	 {
		 ...
		 if(!empty($_POST['updating']))
		 {
			...
			$currentDateTime = date('Y-m-d H:i:s');
			$description = "You have Updated a CosPlay The id is:".$id." named :".$name."<br> Color : ".$color."<br> the Referance: ".$reference;
			$newActivitie = new Activities('', $_SESSION['idAdmin'], $description, $currentDateTime, '');
			CrudActivities::insert($newActivitie);	  	 	 
		}
		 else{
			...
			$currentDateTime = date('Y-m-d H:i:s');
			$description = "You have add a new CosPlay named :".$name."<br> Color : ".$color."<br> the reference: ".$reference;
			$newActivitie = new Activities('', $_SESSION['idAdmin'], $description, $currentDateTime, '');
			CrudActivities::insert($newActivitie);	 	 
