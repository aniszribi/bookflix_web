...
$pubC = new pub();
$listepub=$pubC->afficherpublicite();
?>
...
<head>
    ...
    <script src="search-pub.js" defer></script>
            ...
            <main class="content ">
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <div class="input-group" style="width: 300px !important;">
                        <form action="" method="GET" class="input-group" style="width: 300px !important;">
                            <input type="text" class="form-control" placeholder="Search ... " name="search-pub"
                                id="inp">
                    ...
                    <div id="popup-container-Admin" class="popup-container-Admin" style="width: 28%;">
                        <a href="page-publicite.php" id="close-popup-Admin"><i class="fas fa-times"></i></a>
                        <div id="popup-content-Admin" class="">

                            <h4 class="model-titel">Add a new publicité </h4>
                            <form action="ajout-pub.php" method="post">
                                <!--product name-->
                                ...
                                <input type="date" placeholder="" id="date2" name="date2">
                                <!--product price-->
                                <label for="imagee">imagee:</label>
                                <input type="file" placeholder="" id="imagee" name="imagee">
                                <!--Number Of Photos-->
                                <label for="descriptions">descriptions :</label>
                                <textarea class="form-control" name="descriptions" id="descriptions" rows="2"
                                    minlength="2" placeholder="Textarea"></textarea>

                                <div class="d-flex align-items-center justify-content-between mb-3  ">
                                    <a href="page-publicite.php" class="btn btn-secondary btn-block mt-3"
                            ...
                            <div class="card flex-fill">
                                ...
                                <div class="main" id="main">
                                    <table class="table table-hover my-0">
                                        ...
                                        <tbody>
                                            <?php foreach ($listepub as $publicite): ?>
                                            <tr>
                                                <td>
                                                ...
                                                <td style="width=" 70%>
                                                    <form method="POST" action="supprimer-pub.php">
                                                        ...
                                                        <input type="hidden" value="<?php echo $publicite['id']; ?>"
                                                            name="id">
                                                    </form>
                                                </td>
                                                <td style="width=" 70%>
                                                <td><a class="btn btn-success btn-block"
                                                        href="modifier-pub.php?id=<?PHP echo $publicite['id']; ?>">
                                                        Modifier</a></td>
                                                </td>
