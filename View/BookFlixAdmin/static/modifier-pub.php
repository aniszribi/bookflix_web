...
if (isset($_GET['id'])){ 
    $pubC=new pub();
    $result=$pubC->recupererpublicite($_GET['id']);

    foreach($result as $publicite){
        $id=$publicite['id'];
        $nom=$publicite['nom'];
        $date1=$publicite['date1'];
        $date2=$publicite['date2'];
        $imagee=$publicite['imagee'];
        $descriptions=$publicite['descriptions'];
?>
...
<div class="row">
        <div class="col-md-20">
            <h3 class="text-center text-info">Update publicite</h3>
            <hr>
...
<div class="form-group">
<input class="form-control" required placeholder="DateDebut" type="Date" name="date1" value="<?PHP echo $date1 ?>">
</div>

<div class="form-group">
<input class="form-control" required placeholder="DateFin" type="Date" name="date2" value="<?PHP echo $date2 ?>">
</div>
<div class="form-group">
<input class="form-control"  type="file" name="imagee" value="<?PHP echo $imagee ?>">
</div>
<div class="form-group">
<input class="form-control"  type="text" name="descriptions" value="<?PHP echo $descriptions ?>">
</div>
...
if (isset($_POST['modifier'])){
    $imagee="./src/".$_POST['imagee']; 
    $pubC=new pub();
    $publiciteC=new publicite($_POST['id'],$_POST['nom'],$_POST['date1'],$_POST['date2'],$_POST['imagee'],$_POST['descriptions']);
    $pubC->modifierpublicite($publiciteC,$_GET['id']);
    echo $_POST['id'];
